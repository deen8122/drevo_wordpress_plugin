var preAreaName, selAreaName, XMLPath, selName, parentID;
...
function createXmlHttpRequestObject(){
	...
	if(!obj) alert('Ваш браузер не сможет корректно работать с данной страницей, т.к. это не браузер, это херня какаято...'); else return obj;
}
