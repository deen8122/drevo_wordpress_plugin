...
require_once $CURFLD.'excel/Writer/Format.php';
require_once $CURFLD.'excel/Writer/BIFFwriter.php';
require_once $CURFLD.'excel/Writer/Worksheet.php';
require_once $CURFLD.'excel/Writer/Parser.php';
require_once $CURFLD.'ole/PPS/Root.php';
require_once $CURFLD.'ole/PPS/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    function Spreadsheet_Excel_Writer_Workbook($filename)
    {
        ...
        $this->_formats          = array();
        $this->_palette          = array();
        $this->_codepage         = 0x04E3; //0x04E4; // FIXME: should change for BIFF8
